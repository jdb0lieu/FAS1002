...
---
class: center,
#Faire des régressions linéaires

```{r, warning=FALSE,message=FALSE, results = FALSE, echo = FALSE}


bec_taille_long <- ggplot(data = penguins,
  ...
  theme_minimal() +
  scale_color_manual(values = c("midnightblue","royalblue","seagreen4")) +
  labs(title = "Taille du bec des pingouins",
       subtitle = "Taille du bec des pingouins pour les ésàces Adelie, Chinstrap et Gentoo à la station Palmer LTER",
